...
// Display footer
      function fc_text_inputreal() {
        if(True== get_option('checkboxhf'))
             echo '<div id="plugin_hd_credit"><a href="http://www.trottyzone.com/">Powered by TROTTYZONE</a>.</div><div class="footertext" align="center" style="background-image:url('.get_option('fc_uplo2').');background-color:'.get_option('fc_backgroundpick2').';color:'.get_option('fc_textpick2').';">'.get_option('fc_input_text').'</div>';
}
